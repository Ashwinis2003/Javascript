...
let frames_per_sec=frames(12,4)
console.log(frames_per_sec);
...
console.log(getFullName("John","Peter"));
...
console.log(PositiveNumbers([-4,-7,9,2,15,3,9,-5]));
...
console.log(MaxNumbers([2,0,19,12,10,14,16,-3]));
